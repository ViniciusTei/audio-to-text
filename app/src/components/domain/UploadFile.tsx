...
function UploadFile({ onUpload }: Props) {
  ...
  return (
    <div ref={dropRef} className="h-56 p-10 flex mt-4 items-center justify-center flex-col text-xl text-white border-2 border-dashed border-gray-500 rounded-xl">
      ...
      <div>
        <button onClick={handleUploadClick} className="w-full flex items-center rounded-md border-0 py-1.5 pl-7 pr-8 text-gray-200 ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 text-sm sm:leading-6">
