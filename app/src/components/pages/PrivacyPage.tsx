...
function PrivacyPage() {
  return (
    <div className="mt-20 md:px-20">
      <h1 className="text-lg font-semibold my-8">Política Privacidade</h1>
      <p><span>A sua privacidade é importante para nós. É política do TranscreveAi respeitar a sua privacidade em relação a qualquer informação sua que possamos coletar no site <a className="underline" href="https://audio-to-text-pink.vercel.app/">TranscreveAi</a>, e outros sites que possuímos e operamos.</span></p>
      ...
      <p><span >O nosso site pode ter links para sites externos que não são operados por nós. Esteja ciente de que não temos controle sobre o conteúdo e práticas desses sites e não podemos aceitar responsabilidade por suas respectivas&nbsp;</span><a className="underline" href="https://politicaprivacidade.com/" rel="noopener noreferrer" target="_blank">políticas de privacidade</a><span>.</span></p>
      ...
      <ul>
        ...
        <li><span >C) Não causar danos aos sistemas físicos (hardwares) e lógicos (softwares) do TranscreveAi, de seus fornecedores ou terceiros, para introduzir ou disseminar vírus informáticos ou quaisquer outros sistemas de hardware ou software que sejam capazes de causar danos anteriormente mencionados.</span></li>
      </ul>
      ...
      <p><span >Esta política é efetiva a partir de&nbsp;20 August 2023 17:04</span></p>
    </div>
  )
}
